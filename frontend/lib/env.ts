...
export const ENV = {
  ...
  ALLOWED_FILE_TYPES: (
    process.env.NEXT_PUBLIC_ALLOWED_FILE_TYPES || ".pdf,.txt,.docx"
  ).split(","),
...
/**
 * Returns the appropriate API URL based on the execution context
 *
 * - Client-side (browser): Uses NEXT_PUBLIC_API_URL for public access (http://localhost:PORT)
 */
